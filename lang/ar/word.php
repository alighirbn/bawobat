...
return [
    ...
    // dashboard
    'dashboard_msg' => 'مرحباً بك في نظام شركة بوابة العلم للمقاولات والاستثمارات العقارية في محافظة النجف الأشرف',
    ...
    'reports' => 'التقارير',
    //nav
    'report_trialBalance' => 'ميزان المراجعة',
    'report_trialBalanceCostCenter' => 'ميزان المراجعة حسب مركز الكلفة',
    'report_balance_sheet' => 'الميزانية العمومية',

    //report_info
    'report_info' => 'بيانات المرحلة',
