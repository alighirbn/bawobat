        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        <tbody>
                            @foreach ($trialBalance as $entry)
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($entry['debits'], 2) }}</td>
                                    <td>{{ number_format($entry['credits'], 2) }}</td>
                    ...
                    <h2>Total Debits: {{ number_format($totalDebits, 2) }}</h2>
                    <h2>Total Credits: {{ number_format($totalCredits, 2) }}</h2>
